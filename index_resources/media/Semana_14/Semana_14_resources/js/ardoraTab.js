...
if ($(".txtCell_input").length !=0) { $(".txtCell_input").css("background-color","#FFFFFF"); $(".txtCell_input").css("color",colorText);};
if ($(".txtCell_txt").length !=0) { $(".txtCell_txt").css("background-color","#FFFFFF")}
if ($(".txtCell_txt").length !=0) {var color2="#FF8080";var color1="#FFFFFF";
