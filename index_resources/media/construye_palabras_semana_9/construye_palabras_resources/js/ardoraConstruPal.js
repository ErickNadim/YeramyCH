...
$("#help_div").html("<img tabindex='0' id='playSound' class='imaLeft' src='construye_palabras_resources/media/' alt='Play' align='left'>"+ "<p>" +ConstruPalWords(cp_que[jobindex[indexGame-1]])+ "</p>");
...
$(iDiv).css("position","absolute");$(iDiv).css("left",0);$(iDiv).css("cursor", "pointer");$(iDiv).css("margin-top",0);var imadir='construye_palabras_resources/media/'+cp_ima[jobindex[indexGame - 1]].trim();
...
var imab_dir ="construye_palabras_resources/media/b_" + cp_ima[jobindex[indexGame - 1]].trim();
...
$(this).animate({marginTop: String(200-$(this).outerHeight()-2)+"px",left: String(posAns)+"px"}, "slow");posAns=posAns+$(this).outerWidth()+2;$(this).removeClass("bg");answers.push(parseInt($(this).attr("id").substring(2,9)));
